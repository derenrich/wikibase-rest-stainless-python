...
from wikibase_rest_stainless._compat import PYDANTIC_V1, parse_obj, model_dump, model_json
from wikibase_rest_stainless._models import DISCRIMINATOR_CACHE, BaseModel, construct_type
