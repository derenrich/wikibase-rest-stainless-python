...
from wikibase_rest_stainless import DefaultAioHttpClient, WikibaseRestStainless, AsyncWikibaseRestStainless
from wikibase_rest_stainless._utils import is_dict
